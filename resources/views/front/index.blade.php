                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <div class="suggestion-box-wrap-main">
                                            ...
                                            <div
                                                    ...
                                                    @if (auth()->user()->likes()->where('post_id', $post->id)->exists())
                                                        <button class="like" data-post-id="{{ $post->id }}"
                                                            style="background: transparent; border:none"><span
                                                                class="like-color"><i class="fa-solid fa-thumbs-up mr-2"
                                                                    style="color: #74C0FC;"><span>Unlike</span></i></i></span></button>
                                                    @else
                                                        <button class="like" data-post-id="{{ $post->id }}"
                                                            style="background: transparent; border:none"><span
                                                                class="like-color"><i
                                                                    class="fa-solid fa-thumbs-up me-2 like-color"><span>Like</span></i></span></button>
                                                    @endif
                                                </div>
                                                {{-- Show Comment --}}
                                                <div class="comment-btn-main" id="commentBox">
                                                    <form onsubmit="event.preventDefault();">
                                                        @csrf
                                                        <input type="hidden" id="load-id" name="post_id"
                                                            value="{{ $post->id }}">
                                                        <input type="hidden" id="user-id" name="user_id"
                                                            value="{{ auth()->user()->id }}">
                                                        <span class="comment-load"><i
                                                                class="fa-solid fa-message me-2"></i> Comments</span>
                                                    </form>
                                                </div>
                                            ...
                                            <div class="comments-sec" id="commentSec">
                                                ...
                                                {{-- End Show Comment --}}
                                                <div class="comments-box comments-{{ $post->id }}">
                                                ...
                                                <form onsubmit="event.preventDefault();">
                                                    @csrf
                                                    <div
                                                        class="comments-post d-flex align-items-center comment-my position-relative">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="comments-input">
                                                                <input type="hidden" id="post-id" name="post_id"
                                                                    value="{{ $post->id }}">
                                                                <input type="hidden" id="us-id" name="user_id"
                                                                    value="{{ auth()->user()->id }}">
                                                    ...
                                                    <button style="    color: #65676b;     border: none; font-size: 23px;     margin-right: 28px;"
                                        class=" comment-btn"><i class="fa-solid fa-paper-plane"></i></button>
                                                                <button class="comments-additional-btn p-0"><img
                                                        ...
                                                        <span class="text-danger comment-err"
                                                            style="    position: absolute;top: -30px;left: 88px;"></span>
                                                    </div>
                                                </form>
                                                {{-- End New Comment --}}
                                                <div class="subscribe-btn d-flex justify-content-center">
                                                    <a href="{{ route('user.plan') }}" class="register-btn">Subscribe
                                                        First</a>
                                                </div>
                                            </div>
                    ...
                    success: function(data) {
                        if (data.message === 'Liked' || data.message === 'Unliked') {
                            ...
                            if (data.message === 'Liked') {
                                $('.like-color').html(
                                    '<i class="fa-solid fa-thumbs-up mr-2" style="color: #74C0FC;"><span>Unlike</span></i>'
                                );
                            } else {
                                $('.like-color').html(
                                    '<i class="fa-solid fa-thumbs-up me-2 like-color"><span>Like</span></i> '
                                )
                            }
                        }
                    }
...
@push('comment-scripts')
    <script>
        function diffForHumans(dateTimeString) {
        ...
        $(document).ready(function() {
            ...
            $('.comment-btn').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        var comm_box = '.comments-' + postId;
                        var dateTimeString = data.created_at;
                        var time = diffForHumans(dateTimeString);
                        $("#comment-input").val('');
                        var newComment = ` <div class="comments-box-wrp">
                                                        <div class="comments-profile">
                                                            <img src="{{ asset('assets/user/images/comments-profile.png') }}"
                                                            class="img-fluid" alt="">
                                                        </div>
                                                        <div class="comments-here">
                                                            <div class="comments-here-first">
                                                                ...
                                                                <h5 class="d-flex align-items-center">${data.comments}
                                                                    <img src="{{ asset('assets/user/images/party-head-removebg-preview.png') }}"
                                                                    class="party-img" alt="...">
                                                                </h5>
                                                            </div>
                        ...
                        $(comm_box).append(newComment);
                    },
                    error: function(error) {
                        $(".comment-err").text(error.responseJSON.message);
                        console.log(error.responseJSON.message);
                    }
                })
            })
            // Show Comment
            $('.comment-load').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        var comm = '.comments-' + loadId;
                        $(comm).empty();
                        for (var i = 0; i < data.length; i++) {
                            var dateTimeString = data[i].created_at;
                            var result = diffForHumans(dateTimeString);
                            var allComment = `<li> <div class="comments-box-wrp">
                                                        <div class="comments-profile">
                                                            <img src="{{ asset('assets/user/images/comments-profile.png') }}"
                                                            class="img-fluid" alt="">
                                                        </div>
                                                        <div class="comments-here">
                                                            <div class="comments-here-first">
                                                                <h5>${data[i].user.name} </h5>
                                                                <h5 class="d-flex align-items-center">${data[i].comments}
                                                                    <img src="{{ asset('assets/user/images/party-head-removebg-preview.png') }}"
                                                                    class="party-img" alt="...">
                                                                </h5>
                                                            </div>
